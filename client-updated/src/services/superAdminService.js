...
const superAdminService = {
  ...
  getRestaurants: async (params = {}) => {
    const { data } = await superAdminApi.get("/super-admin/restaurants", { params });
    return data.data; // restaurants[]
  },

  deleteRestaurant: async (id) => {
    const { data } = await superAdminApi.delete(`/super-admin/restaurants/${id}`);
    return data.data; // deletion result
  },
