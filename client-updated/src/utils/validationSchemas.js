...
// Mirrors server/validators/employee.validation.js. Password is required
// only when creating a new employee — the edit form omits the field
// entirely, so this schema is reused with `password` made optional there.
...
export const employeeEditSchema = employeeSchema.omit({ password: true });
